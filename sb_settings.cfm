...
<cfSet sb.developmentServers = "intranet-test.server.gvsu.edu,148.61.10.66,intranet-test.gvsu.edu,localhost" />
...
<cfSet sb.defaultNoSessionPath = "index.htm" /> <!--- WHERE SWITCHBOARD WILL REDIRECT TO IF SESSIONCHECK IS *NOT* DEFINED AND THE USER ATTEMPTS TO ACCESS A PAGE THEY HAVE TO BE LOGGED INTO --->
